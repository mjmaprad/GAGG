...
/////////////////////////////////////////////////////////////////////////////////////////////////////7/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  density = 6.63*g/cm3;
    ...
    fBC408->AddElement(eGd,0.509);
    fBC408->AddElement(eAl,0.058);
    fBC408->AddElement(eGa, 0.226);
    fBC408->AddElement(eO,0.207);
...
////Attenuation characteristics of a Ce:Gd 3 Al 2 Ga 3 O 12 scintillator
...
BC408->AddConstProperty("FASTTIMECONSTANT", 90*ns);///fast component of the order of 60-130ns
BC408->AddConstProperty("SLOWTIMECONSTANT", 260*ns);//a slow component of the order of several hundred nanoseconds (260-530ns).
BC408->AddConstProperty("SCINTILLATIONYIELD",50000./MeV);
BC408->AddConstProperty("YIELDRATIO",1.0);
BC408->AddConstProperty("RESOLUTIONSCALE",5.2);//http://eprints.gla.ac.uk/116774/7/116774.pdf
//////// for LYSO RESOLUTIONSCALE is 8 
